...
public class Utils {
    ...
    public static List<SocketSessionBean> readCSVFileData(String srcPath) {

        BufferedReader reader = null;
        List<SocketSessionBean> socketSessionBeanSet = new LinkedList<>();
        String line = null;
        try {
        ...
        try {
            while ((line = reader.readLine()) != null) {
                ...
                if (input.length < 1) {
                    ...
                    // 0=登陆信息 1=pub信息
                    socketSessionBeanSet.add(SocketSessionBean.builder().loginMessage(input[0]).pubMessage(input[1]).build());
                }
